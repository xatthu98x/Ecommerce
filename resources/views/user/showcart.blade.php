  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="/redirect"><h2>Billion <em>Gear</em></h2></a>
    ...
    <table>
        <tr style="background-color:#232323; color:white">
            <td style="padding:10px; font-size:20px ">Product Image</td>
    ...
    @foreach($cart as $carts)
        ...
        <tr style="background-color:#232323">
            <td style="padding:10px; color:white"><img width="100" height="100" src="/productimage/{{($carts->image)}}" alt=""></td>
